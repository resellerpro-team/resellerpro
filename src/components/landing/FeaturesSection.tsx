  ...
  const features = [
    {
      ...
      description:
        "Organize products with images, pricing, and profit calculations. Know exactly what you're earning.",
    },
    {
      icon: Users,
      title: 'Customer Database',
      description:
        'Save customer details once, reuse forever. Track order history and build relationships.',
    },
    {
      icon: Zap,
      title: 'Smart WhatsApp Paste',
      description:
        'Copy customer messages from WhatsApp, paste in app. Auto-extract name, phone, address!',
    },
    {
      icon: BarChart3,
      title: 'Analytics & Reports',
      description:
        "Daily, weekly, monthly reports. See what's selling, who's buying, and how much you're earning.",
    },
    {
      icon: Shield,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 space-y-6">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Powerful features designed specifically for resellers who want to scale their business
            efficiently
          </p>
        </div>

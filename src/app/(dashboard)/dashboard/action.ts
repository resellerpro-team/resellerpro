...
//     const { data: todayOrders } = await (await supabase)
//       .from('orders')
...
//     const { data: yesterdayOrders } = await (await supabase)
//       .from('orders')
//       .select('total_amount, total_profit')
//       .eq('user_id', user.id)
...
//     const { count: totalCustomers } = await (await supabase)
//       .from('customers')
//       .select('*', { count: 'exact', head: true })
//       .eq('user_id', user.id)

//     // Fetch customers created before today
//     const { count: yesterdayCustomers } = await (await supabase)
//       .from('customers')
//       .select('*', { count: 'exact', head: true })
//       .eq('user_id', user.id)
...
//     const { data: currentMonthOrders } = await (await supabase)
//       .from('orders')
//       .select(`
//         id,
//         created_at,
...
//     const { data: lastMonthOrders } = await (await supabase)
//       .from('orders')
//       .select(`
//         order_items (
//           product_id,
...
//         trend: (product.sold >= product.lastMonthSold ? 'up' : 'down') as 'up' | 'down',
//       }))
...
//     const { count: pendingOrders } = await (await supabase)
//       .from('orders')
//       .select('*', { count: 'exact', head: true })
//       .eq('user_id', user.id)
//       .eq('status', 'pending')
...
//     const { count: lowStockProducts } = await (await supabase)
//       .from('products')
//       .select('*', { count: 'exact', head: true })
//       .eq('user_id', user.id)
...
//     const { data: monthlyOrders } = await (await supabase)
//       .from('orders')
//       .select('total_amount')
//       .eq('user_id', user.id)
//       .gte('created_at', monthStart)
...
//     }
//   } catch (error: any) {
//     console.error('Error fetching dashboard alerts:', error.message)
//     return {
//       pendingOrders: 0,
//       lowStockProducts: 0,
//       monthlyRevenue: 0,

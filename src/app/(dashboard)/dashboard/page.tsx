...
import { StoreLiveBanner } from '@/components/dashboard/StoreLiveBanner'
...
export default async function DashboardPage() {
  ...
  const [stats, revenueData, recentOrders, alerts, enquiries, topProducts, todos, suggestions, profile, shopProfile] = await Promise.all([
    getDashboardStats(),
    getRevenueChartData(),
    getRecentOrders(),
    getDashboardAlerts(),
  ...
  return (
    <div className="space-y-6">
      ...
      <StoreLiveBanner shopProfile={shopProfile} />
      <WelcomeToast />
      {/* Header */}
      <div>

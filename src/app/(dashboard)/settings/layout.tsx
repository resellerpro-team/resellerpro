...
//           <nav className="flex sm:space-x-2 lg:flex-col lg:space-x-0 lg:space-y-1 border">
//             {sidebarNavItems.map((item) => (
//               <Link
//                 key={item.href}
//                 href={item.href}
//                 className={cn(
//                   "inline-flex items-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 justify-start",
//                   pathname === item.href
